/**
 * DriveHub Goa - Cookie Consent Manager
 * GDPR & India DPDP Act 2023 baseline compliant
 */

export const COOKIE_CONSENT_KEY = "dh_cookie_consent_v1";
export const COOKIE_CONSENT_VERSION = "1.0.0";
export const COOKIE_CONSENT_EXPIRY_DAYS = 365; // 12 Months
export const CONSENT_UPDATED_EVENT = "dh_cookie_consent_updated";
export const OPEN_PREFERENCES_EVENT = "dh_open_cookie_preferences";
