/* Brex / Urbanist Design System - Cookie Consent Manager (Journey Rentals Solapur) */
  ...
  return (
    <>
      <aside
        ...
        className="fixed bottom-0 inset-x-0 z-50 p-3 sm:p-5 pointer-events-none animate-in fade-in slide-in-from-bottom-5 duration-300 font-body text-left"
      ...
      >
        <div className="pointer-events-auto max-w-5xl mx-auto w-full bg-white border border-[#DFDCE8] rounded-[24px] shadow-2xl overflow-hidden text-[#212121]">
          ...
          <div className="p-5 sm:p-7 space-y-4">
              ...
              <div className="flex items-start gap-3.5 flex-1 text-left">
                ...
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] uppercase px-2.5 py-0.5 rounded-full bg-[#F6F5FA] text-[#6F6E73] border border-[#DFDCE8] font-bold">
                      GDPR &amp; DPDP Compliant
                    </span>
                  </div>
                  <p className="text-xs sm:text-sm text-[#6F6E73] leading-relaxed max-w-3xl font-normal">
                    Journey Rentals uses cookies and secure local storage to keep your rental booking session safe, remember vehicle preferences, and measure browsing performance. You can customize your consent below.
                  </p>
                </div>
              </div>
            ...
            {expanded && (
              <div className="pt-4 border-t border-[#DFDCE8] space-y-4 text-left animate-in fade-in duration-200">
                <div className="grid sm:grid-cols-2 gap-3">
                  {/* 1. Strictly Necessary */}
                  <div className="p-4 rounded-[20px] bg-white border border-[#212121]/20 shadow-xs space-y-2 text-left transition-all">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <div className="w-7 h-7 rounded-full bg-[#F6F5FA] border border-[#DFDCE8] flex items-center justify-center text-[#212121]">
                          <Lock size={13} className="text-[#212121]" />
                        </div>
                        <span className="font-bold text-xs text-[#212121]">Strictly Necessary</span>
                      </div>
                      <span className="text-[10px] font-bold text-[#4B8039] bg-[#CFDECA] px-2.5 py-0.5 rounded-full">
                        Always Active
                      </span>
                    </div>
                  ...
                  {/* 2. Analytics */}
                  <div className={`p-4 rounded-[20px] border space-y-2 text-left transition-all ${
                    preferences.analytics ? "bg-white border-[#212121]/25 ring-1 ring-[#212121]/10 shadow-xs" : "bg-[#F6F5FA] border-[#DFDCE8]"
                  }`}>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <div className="w-7 h-7 rounded-full bg-[#F6F5FA] border border-[#DFDCE8] flex items-center justify-center text-[#212121]">
                          <BarChart3 size={13} className="text-[#212121]" />
                        </div>
                      ...
                      <div className="flex items-center gap-2">
                        <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                          preferences.analytics ? "bg-[#CFDECA] text-[#4B8039]" : "bg-[#DFDCE8] text-[#6F6E73]"
                        }`}>
                          {preferences.analytics ? "Active" : "Off"}
                        </span>
                        <Switch
                          id="toggle-analytics"
                  ...
                  {/* 3. Marketing & Offers */}
                  <div className={`p-4 rounded-[20px] border space-y-2 text-left transition-all ${
                    preferences.marketing ? "bg-white border-[#212121]/25 ring-1 ring-[#212121]/10 shadow-xs" : "bg-[#F6F5FA] border-[#DFDCE8]"
                  }`}>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <div className="w-7 h-7 rounded-full bg-[#F6F5FA] border border-[#DFDCE8] flex items-center justify-center text-[#212121]">
                          <Megaphone size={13} className="text-[#212121]" />
                        </div>
                      ...
                      <div className="flex items-center gap-2">
                        <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                          preferences.marketing ? "bg-[#CFDECA] text-[#4B8039]" : "bg-[#DFDCE8] text-[#6F6E73]"
                        }`}>
                          {preferences.marketing ? "Active" : "Off"}
                        </span>
                        <Switch
                          id="toggle-marketing"
                    ...
                    <p className="text-[11px] text-[#6F6E73] leading-normal font-normal">
                      Enables seasonal Solapur car &amp; bike rental discounts, festive pilgrimage promo codes, and customized self-drive travel deals.
                    </p>
                  </div>

                  {/* 4. Preferences & Functional */}
                  <div className={`p-4 rounded-[20px] border space-y-2 text-left transition-all ${
                    preferences.preferences ? "bg-white border-[#212121]/25 ring-1 ring-[#212121]/10 shadow-xs" : "bg-[#F6F5FA] border-[#DFDCE8]"
                  }`}>
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        <div className="w-7 h-7 rounded-full bg-[#F6F5FA] border border-[#DFDCE8] flex items-center justify-center text-[#212121]">
                          <SlidersHorizontal size={13} className="text-[#212121]" />
                        </div>
                      ...
                      <div className="flex items-center gap-2">
                        <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                          preferences.preferences ? "bg-[#CFDECA] text-[#4B8039]" : "bg-[#DFDCE8] text-[#6F6E73]"
                        }`}>
                          {preferences.preferences ? "Active" : "Off"}
                        </span>
                        <Switch
                    ...
                    <p className="text-[11px] text-[#6F6E73] leading-normal font-normal">
                      Remembers your selected pickup railway station &amp; city hubs, date presets, and preferred vehicle class (Cars/Bikes).
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-2">
                  ...
                  <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
                    ...
                    <Button
                      ...
                      className="h-10 px-5 text-xs font-bold uppercase tracking-wider text-[#212121] bg-[#e1b808] hover:bg-[#E5E696] rounded-full shadow-xs cursor-pointer"
